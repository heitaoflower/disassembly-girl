...
{
    public class TransitionEngine : MonoBehaviour
    {
        ...
        /// </summary>
        private static TransitionEngine _instance;
        public static TransitionEngine instance
        {
            get
            {
                if (!_instance)
                {
                    ...
                    _instance = FindObjectOfType(typeof(TransitionEngine)) as TransitionEngine;

                    if (!_instance)
                    {
                        var obj = new GameObject("TransitionEngine");
                        obj.layer = _transitionKitLayer;
                        obj.transform.position = new Vector3(99999f, 99999f, 99999f);

                        _instance = obj.AddComponent<TransitionEngine>();
